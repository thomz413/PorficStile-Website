	...
	if (variant === "sticky") {
		return (
			<button
				...
				className="fixed bottom-8 right-8 z-40 flex items-center justify-center h-16 w-16 rounded-full bg-secondary text-white shadow-2xl hover:bg-secondary/90 transition-smooth hover:scale-110 border-2 group"
