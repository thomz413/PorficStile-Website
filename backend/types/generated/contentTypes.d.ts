...
export interface ApiConfiguracionConfiguracion extends Struct.SingleTypeSchema {
  collectionName: 'configuracions';
  info: {
    displayName: 'Configuraci\u00F3n';
    pluralName: 'configuracions';
    singularName: 'configuracion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    numeroWhatsapp: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'51999999999'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cantidadStock: Schema.Attribute.Integer;
    ...
    fechaFinOferta: Schema.Attribute.DateTime;
    fechaInicioOferta: Schema.Attribute.DateTime;
    galeria: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    imagenPrincipal: Schema.Attribute.Media<'images' | 'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    precioOferta: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nombre'> & Schema.Attribute.Required;
    textoBadgeOferta: Schema.Attribute.String;
    tipoDescuento: Schema.Attribute.Enumeration<['porcentaje', 'fijo']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valorDescuento: Schema.Attribute.Decimal;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::configuracion.configuracion': ApiConfiguracionConfiguracion;
