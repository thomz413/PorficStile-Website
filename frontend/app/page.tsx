				...
				<div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 w-full">
					<div className="text-center space-y-8">
						...
						<h1 className="font-black text-white leading-none tracking-tight mb-4">
							<span className="block text-6xl md:text-7xl lg:text-8xl mb-2">
								Atlantis
							</span>
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
							<Link
								href="/productos"
								className="inline-flex items-center justify-center gap-3 bg-accent text-accent-foreground px-8 py-4 font-black hover:bg-accent/90 transition-all duration-500 group shadow-2xl hover:-translate-y-1 uppercase tracking-widest text-sm hover:shadow-accent/25"
							>
								Ver Catálogo
				...
				<div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
					<div className="space-y-8">
						...
						<p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-2xl mx-auto">
							Descubre nuestra colección de ropa de alta calidad con diseños
							únicos.
						</p>
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
							{whatsappNumber ? (
								<WhatsAppCTA
									...
									className="bg-white text-primary hover:bg-white/90 border-white text-lg px-8 py-4 font-black"
								/>
							) : null}
							<Link
								href="/productos"
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
						<div className="md:col-span-2">
							<h3 className="text-3xl font-black mb-4">
								Atlantis <span className="text-accent">Porfic Stile</span>
							</h3>
					...
					<div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
						<div className="text-center md:text-left">
							<p className="text-slate-400 text-sm">
								© 2024 Atlantis Porfic Stile. Todos los derechos reservados.
							</p>
							<p className="text-slate-500 text-xs mt-1">
								Hecho con ❤️ en el Perú
							</p>
						</div>
						{whatsappNumber && (
							<div className="flex items-center gap-2 text-sm">
								...
								<WhatsAppCTA
									...
									className="bg-accent text-accent-foreground hover:bg-accent/90 border-accent text-xs px-4 py-2"
								/>
							</div>
						)}
					</div>
